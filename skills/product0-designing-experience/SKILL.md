...
description: Use when a user or older workflow invokes the former product-experience stage; retained only to route existing Product0 installations into the v0.2 workflow.
license: MIT
