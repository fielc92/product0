...
- Added strict pre-implementation state machine.
- Added one canonical product brief per initiative.
- Added developer-side technical brainstorming bridge.
- Added one-file-per-session conversation memory.
- Added portable Agent Skills metadata, eval fixtures, and repository validation.
